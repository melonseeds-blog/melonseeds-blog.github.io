...
const POST_NAV_DATA = {
    ...
    'dev-lang-rust': [
        ...
        { file: 'rust-02-syntax.html', title: 'Rust 기본 문법 — 변수·자료형·함수·제어 흐름' },
        { file: 'rust-03-ownership.html', title: '소유권(Ownership) — Rust의 핵심' },
        { file: 'rust-04-borrowing.html', title: '참조와 빌림(Borrowing) — borrow checker' },
        { file: 'rust-05-lifetimes.html', title: '라이프타임(Lifetimes) 기초' },
        { file: 'rust-06-structs.html', title: '구조체(struct)와 메서드(impl)' },
        { file: 'rust-07-enums-match.html', title: '열거형(enum)과 패턴 매칭(match)' },
        { file: 'rust-08-option-result.html', title: 'Option과 Result — null 없는 설계' },
        { file: 'rust-09-collections.html', title: '컬렉션 — Vec·String·HashMap' },
        { file: 'rust-10-generics.html', title: '제네릭(Generics)' },
        { file: 'rust-11-traits.html', title: '트레이트(Trait) — Rust의 다형성' },
        { file: 'rust-12-error-handling.html', title: '에러 처리 심화 — ?·thiserror·anyhow' },
        { file: 'rust-13-modules.html', title: '모듈 시스템과 크레이트' },
        { file: 'rust-14-closures-iterators.html', title: '클로저와 이터레이터' },
        { file: 'rust-15-smart-pointers.html', title: '스마트 포인터 — Box·Rc·RefCell' },
        { file: 'rust-16-concurrency.html', title: '동시성 — thread·Send/Sync·Arc&lt;Mutex&gt;' },
        { file: 'rust-17-async.html', title: '비동기 — async/await와 tokio' },
        { file: 'rust-18-unsafe-ffi.html', title: 'unsafe Rust와 FFI 기초' },
        { file: 'rust-19-macros.html', title: '매크로 — 선언적·절차적' },
